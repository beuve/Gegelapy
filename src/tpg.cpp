...
void add_tpg(py::module_ m) {
  py::class_<GymTrainer>(m, "TPG")
      .def(
          py::init<GymEnvironment &,
                   const std::vector<Instructions::Instruction *> &, size_t,
                   double, uint64_t, uint64_t, uint64_t, double, uint64_t,
                   uint64_t, size_t, size_t, size_t, size_t, std::string, bool,
                   uint64_t, size_t, double, size_t, double, double, double,
                   double, double, size_t, size_t, double, double, double,
                   double, bool, double, double, bool, bool, bool, size_t,
                   size_t, size_t, double, double, double, double, double,
                   double, double, double>(),
          py::arg("env"), py::arg("instructions"), py::kw_only(),
          py::arg("archive_size") = 50, py::arg("archiving_probability") = 0.05,
          ...
          py::arg("ratio_deleted_roots") = 0.5, py::arg("size_tournament") = 5,
          py::arg("nb_generations") = 500,
          py::arg("max_nb_evaluation_per_policy") = 1000,
          py::arg("nb_iterations_per_job") = 1, py::arg("nb_registers") = 8,
          py::arg("nb_program_constant") = 0,
          py::arg("activation_function") = "none",
          py::arg("do_validation") = false, py::arg("step_validation") = 1,
          py::arg("nb_roots") = 100, py::arg("ratio_teams_over_actions") = 1.0,
          ...
          py::arg("nb_action_edge_init") = 1, py::arg("max_outgoing_edges") = 5,
          ...
          py::arg("init_max_program_size") = 10, py::arg("prob_delete") = 0.5,
          py::arg("prob_add") = 0.5, py::arg("prob_mutate") = 1.0,
          py::arg("prob_swap") = 1.0, py::arg("prob_constant_mutation") = 0.5,
          py::arg("prob_new_program") = 0.0, py::arg("min_const_value") = -1.0,
